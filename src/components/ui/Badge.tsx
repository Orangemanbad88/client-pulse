...
const styles: Record<BadgeVariant, string> = {
  ...
  high: "bg-orange-50 dark:bg-orange-900/20 text-amber-600 dark:text-amber-400 border border-orange-100 dark:border-amber-800/30",
  medium: "bg-orange-50 dark:bg-orange-900/20 text-gold dark:text-gold-light border border-gold-light dark:border-gold-muted/30",
  new: "bg-orange-50 dark:bg-orange-900/20 text-gold dark:text-gold-light border border-gold-light dark:border-gold-muted/30",
