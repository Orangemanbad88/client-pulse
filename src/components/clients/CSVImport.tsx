          ...
          {step === 1 && (
            ...
            >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 text-xs font-medium text-white bg-gold hover:bg-gold-muted px-4 py-2 rounded-lg transition-colors shadow-sm shadow-gold/20 active:scale-[0.97]"
              >
          ...
          <div className="flex items-center gap-2">
            ...
            {step === 3 && (
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-medium text-white bg-gold hover:bg-gold-muted px-4 py-2 rounded-lg transition-colors shadow-sm shadow-gold/20 active:scale-[0.97]"
              >
