...
export default function DashboardLoading() {
  return (
    <>
      {/* Header skeleton */}
      <div className="sticky top-0 z-10 hidden lg:block border-b-2 border-[#D4A84B]/40" style={{ background: '#1e3a5f' }}>
      ...
      <div className="px-4 lg:px-8 py-4 lg:py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6">
          <div className="lg:col-span-7">
            <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-xl border border-amber-200/25 dark:border-gray-800/60 overflow-hidden">
